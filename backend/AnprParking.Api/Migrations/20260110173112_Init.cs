    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnprEventLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberVehicles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingAnchorUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnprEventLogs_CreatedUtc",
                table: "AnprEventLogs",
                column: "CreatedUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberVehicles_Plate",
                table: "MemberVehicles",
                column: "Plate",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParkingSessions_Plate_Status",
                table: "ParkingSessions",
                columns: new[] { "Plate", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_Plate",
